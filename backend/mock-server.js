...
const seed = () => {
  ...
  return {
    ...
    brands: [
      { id: 'brand-bomi', name: 'BOMI', slug: 'bomi', description: 'Papeterie et cartables pour la rentree.', logoUrl: '', bannerUrl: '', accentColor: '#F4A9C8', status: 'active', order: 1 },
      { id: 'brand-wama', name: 'WAMA', slug: 'wama', description: 'Instruments d ecriture et fournitures techniques.', logoUrl: '', bannerUrl: '', accentColor: '#8FD8C3', status: 'active', order: 2 },
    ],
    subcategories: [
      { id: 'sub-bomi-2026', brandId: 'brand-bomi', name: 'Collection 2026', slug: 'collection-2026', description: 'Nouveautes de la rentree.', imageUrl: '', status: 'active', order: 1 },
      { id: 'sub-wama-ink', brandId: 'brand-wama', name: 'Ecriture', slug: 'ecriture', description: 'Stylos, feutres et accessoires.', imageUrl: '', status: 'active', order: 1 },
    ],
    products: [
